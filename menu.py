...
Press 8 for attach a EBS Drive to an instance
Press 9 for start/stop the instance
Press 10 for describe all the instances
Press 11 for describe an particular instance
Press 12 for create a new volume
...
\n\n"""))
				...
				if b == 1:
					...
					if instance == "start":
						...
						a = input("Type instance id: ")
						os.system("aws ec2 stop-instances --instance-ids {}".formmat(a))
					else:
					...
					a = int(input("Enter the size of an volume (in integer): "))
					os.system("aws ec2 create-volume --availability-zone {} --size {}".format(avz,ebs_size))
				elif b == 13:
